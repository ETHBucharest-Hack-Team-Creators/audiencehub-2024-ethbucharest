...
const DashboardCreator = ({ addressOfUser }: any) => {
      ...
      try {
        ...
        for (let i = 0; i < itemsData.length; i++) {
          ...
          if (itemsData[i].OneTimePayment === true || itemsData[i].isOneTimePayment) {
            ...
            console.log(
              `Pushed ${itemsData[i].requestid} to one time payments, is one time payment : ${itemsData[i].oneTimePayment}`,
            );
          } else {
  ...
  return (
    <>
                ...
                <tr key={index}>
                  ...
                  <td>
                    <div className="font-bold pl-1">
                      {request.requestData.extensionsData.some((data: any) => data.action === "declareReceivedPayment")
                        ? "Declared"
                      ...
                      {request.requestData.extensionsData.some(
                        ...
                        request.requestData.state === "created" && (
                          <div>
                            ...
                            <button
                              className="btn"
                              onClick={() => document.getElementById(`${request.requestData.requestId}`).showModal()}
                            >
                              Receipt
                            </button>
                                    ...
                                    <div className="md:flex">
                                      <div className="p-8">
                                        ...
                                        <div className="mt-2 text-gray-600">
                                          <p>
                                            <strong>Receipt ID:</strong> {request.requestData.requestId.slice(0, 20)}...
                                          </p>
                                          <p>
                                            <strong>Payer:</strong> {request.requestData.payer.value}
                                          </p>
                                          <p>
                                            <strong>Payee:</strong> {request.requestData.payee.value}
                                          </p>
                                          <p>
                                            <strong>Amount:</strong> ${request.requestData.expectedAmount}
                                          </p>
                                        </div>
                                      </div>
                                    </div>
      ...
      {/* TABLE FANS */}
      <div>
        <h1 className="text-3xl pt-8 pb-4">Accept Item Orders</h1>
      </div>
                                      ...
                                      <div className="p-8">
                                        ...
                                        <div className="mt-2 text-gray-600">
                                          ...
                                          <p>
                                            ...
                                            {String(formatEther(request.requestData.expectedAmount))} ETH
                                          </p>
                                        </div>
                                      </div>
                                    </div>
